...
class CFG:
    ...
    model_path = "VNet4_best_metric_model0.pth",
    sub = "VNet4_submission.csv"
...
train_ds = Dataset(data=train_files, transform=val_transforms)
...
model = VNet(in_channels=1, out_channels=12).to(device)
