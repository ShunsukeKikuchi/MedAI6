...
class CFG:
    best_model_path = "TransferUnetAttPP_seresnext50_32x4d_best_metric_model.pth",
    backbone = "seresnext50_32x4d",
    sub = "Transfer_UnetAttPP_resnet18d_submission.csv"
...
os.chdir('Transfer_Unets/UnetAttPP')
    
model = TimmSegModel(CFG.backbone, segtype='unetpp',pretrained=True)
