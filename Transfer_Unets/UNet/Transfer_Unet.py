...
class CFG:
    ...
    backbone = "seresnext26tn_32x4d",
    model_path = "TransferUnet_best_metric_model.pth",
    sub = "TransferUnet_submission.csv"
...
del inputs, labels, val_inputs, val_labels, val_outputs, val_labels, outputs
