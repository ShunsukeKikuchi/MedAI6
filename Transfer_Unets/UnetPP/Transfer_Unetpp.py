...
class CFG:
    ...
    backbone = "resnet18d",
    model_path = "TransferLink_best_metric_model.pth",
    sub = "TransferLink_submission.csv"
...
os.chdir("/u/home/s/skikuchi/scratch/MedAI6/Resnet18_Unet")
#data_files
...
os.chdir('Transfer_Unets/Transfer_UnetPP')
...
for epoch in range(max_epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            if (metric > best_metric):
                ...
                torch.save(model.state_dict(), "seresUnetAtt_best_metric_model_f4.pth")
    ...
    if epoch%30==0:
        model.load_state_dict(torch.load("seresUnetAtt_best_metric_model_f4.pth"))
    scheduler.step()
