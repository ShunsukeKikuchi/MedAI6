...
class CFG:
    ...
    backbone = "resnext50d_32x4d",
    model_path = "TransferAttUnet_best_metric_model.pth",
    sub = "TransferAttUnet_submission.csv"
...
os.chdir("Transfer_Unets/UnetAtt")
...
model = TimmSegModel(CFG.backbone, attention_type='scse', pretrained=True)
