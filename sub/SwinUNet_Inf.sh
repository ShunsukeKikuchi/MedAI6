...
echo "python SwinUNet_Inf.py"
# call python code with -out only if second arguments is given:

python "/u/home/s/skikuchi/scratch/MedAI6/SwinUnet/SwinUnet_Inf.py"
