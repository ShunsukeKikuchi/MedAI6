...
#$ -o /u/home/s/skikuchi/scratch/MedAI6/joblog/Unet_aug.$JOB_ID
#$ -j y
...
echo "python Transfer_UnetAttpp.py"
# call python code with -out only if second arguments is given:

python "/u/home/s/skikuchi/scratch/MedAI6/UnetAttPP/Transfer_UnetAttpp.py"
