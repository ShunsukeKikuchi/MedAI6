...
#$ -o /u/home/s/skikuchi/scratch/MedAI6/joblog/ResUnet.$JOB_ID
#$ -j y
...
echo "python Transfer_Unet.py"
# call python code with -out only if second arguments is given:

python "/u/home/s/skikuchi/scratch/MedAI6/Transfer_Unets/UNet/Transfer_Unet.py"
