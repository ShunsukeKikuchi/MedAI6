...
#$ -o /u/home/s/skikuchi/scratch/MedAI6/joblog/ResUnet_inf.$JOB_ID
#$ -j y
# Edit the line below to request the appropriate runtime and memory
# (or to add any other resource) as needed:
#$ -l h_rt=10:00:00,h_data=32G,gpu,RTX2080Ti,cuda=1
...
echo "python Transfer_Unet_Inf.py"
# call python code with -out only if second arguments is given:

python "/u/home/s/skikuchi/scratch/MedAI6/Transfer_Unets/transfer_inf.py"
