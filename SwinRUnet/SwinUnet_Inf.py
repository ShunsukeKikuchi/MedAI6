...
class CFG:
    ...
    model_path = "SwinR1_best_metric_model0.pth",
    sub = "SwinR1_submission.csv"
...
model = SwinUNETR(img_size=(128,128,128), in_channels=1, out_channels=12, depths=(2,2,2,2), use_v2=True).to(device)
import gc
gc.collect()
