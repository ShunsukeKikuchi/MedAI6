...
class CFG:
    ...
    model_path = "SwinR_best_metric_model0.pth",
    sub = "SwinR_submission.csv"
...
model = SwinUNETR(img_size=(128,128,128), 
                  ...
                  depths=(2,2,2,2), use_v2=True).to(device)
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), "swin_best_metric_model_ft.pth")
